...
JOI 市の市長である K 理事長は，この道路網の\textgt{整備計画}を作ることにした．整備計画は，$0$ 回以上の\textgt{整備}からなる．
$1$ 回の整備では，$1 \leqq i \leqq H$ を満たす整数 $i$ を $1$ つ選び，以下のことを行う：

<p style="text-indent: 4rem">
$1 \leqq j \leqq W - 1$ を満たす\textgt{すべての}整数 $j$ について，北から $i$ 本目の東西方向の道路の，交差点 $(i, j)$ と交差点 $(i, j + 1)$ を繋ぐ部分を（もし通行止めであれば）通行可能にする．これには全体で $C_i$ 日間かかる．ただし，$C_i$ は $1$ または $2$ である．
</p>
...
<img src="https://img.atcoder.jp/joi2024ho/c5f1d272e8103beee21f2bb2c00a7891.png"/>
